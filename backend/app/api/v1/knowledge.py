...
def list_documents(session: SessionDep, agent_id: str | None = None) -> KnowledgeDocumentListResponse:
...
def search_documents(payload: KnowledgeSearchRequest) -> KnowledgeSearchResponse:
    return knowledge_controller.search_documents(payload)
...
def get_document_download(
    ...
    return knowledge_controller.get_document_download(session, document_id, expires_hours=expires_hours)
